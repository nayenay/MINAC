/*
  ...
  (ADS1115 por I2C, canal A0=MQ-2, A1=MQ-136, A2=MQ-7, A3=MQ-9,
  con divisor de voltaje 10k/20k en cada sensor)

  NOTA: A1 es MQ-136 (H2S, reemplazó a MQ-3). A2 es MQ-7 (CO dedicado,
  reemplazó a MQ-135). El circuito ya no cubre CO2 — hueco de cobertura
  documentado, junto con SO2 y déficit de O2.
...
const char* NOMBRE_SENSOR[4] = { "MQ-2", "MQ-136", "MQ-7", "MQ-9" };
